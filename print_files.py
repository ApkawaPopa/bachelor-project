...
is_needed = {
    ...
    r'C:\Users\ark13\MPU\Диплом\amina\backend\src\main\java\minchakov\arkadii\amina\dto\ChatPictureChangedEvent.java',
    ...
    r'C:\Users\ark13\MPU\Диплом\amina\backend\src\main\java\minchakov\arkadii\amina\service\EventSender.java',
    ...
    r'C:\Users\ark13\MPU\Диплом\amina\frontend\src\assets\theme.css',
    ...
    r'C:\Users\ark13\MPU\Диплом\amina\frontend\src\components\profile\ProfileModal.vue',
    ...
    r'C:\Users\ark13\MPU\Диплом\amina\frontend\.env.example',
    ...
    r'C:\Users\ark13\MPU\Диплом\amina\docker-compose.env.example',
    r'C:\Users\ark13\MPU\Диплом\amina\docker-compose.yml',

    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\00-abstract.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\12-intro.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\20-analysis.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\30-design.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\40-impl.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\80-conclusion.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\81-biblio.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\90-appendix1.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\90-appendix2.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\90-appendix3.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\preamble.inc.tex',
    # r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ\rpz.tex',
}


def print_files_content(directory, out):
    for root, _, files in os.walk(directory):
        for file_name in files:
            ...
            try:
                ...
                print(f'{os.path.join(root, file_name)[len(directory) + 1:]}:', file=out)
                # print(content)
                print('```', file=out)
                for l in content:
...
if __name__ == '__main__':
    with open(r'C:\Users\ark13\MPU\Диплом\amina\frontend\project_code.txt', 'w', encoding='utf-8') as out:
        print_files_content(
            # directory=r'C:\Users\ark13\MPU\Диплом\Аркадий_Минчаков_221-320_ПЗ',
